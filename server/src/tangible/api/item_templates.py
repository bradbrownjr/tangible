...
_SCAFFOLD: dict[str, list[dict]] = {
    "music": [
        {"name": "Vinyl", "category_slug": "music.vinyl", "fields": [
            ...
            {"key": "format", "label": "Format", "type": "select",
             "options": ["LP", "EP", "12\"", "10\"", "7\"", "45", "78", "Flexi"]},
            {"key": "pressing_type", "label": "Pressing type", "type": "select",
             "options": ["Original", "Reissue", "Repress", "Bootleg", "Test Pressing", "Promo"]},
            {"key": "color_vinyl", "label": "Vinyl color", "type": "text"},
        ...
        {"name": "Compact Disc", "category_slug": "music.cd", "fields": [
            ...
            {"key": "country", "label": "Country", "type": "text"},
            {"key": "edition_type", "label": "Edition", "type": "select",
             "options": ["Standard", "Deluxe", "Limited", "Promo", "SACD", "Hybrid SACD", "HDCD", "Gold Disc"]},
        ...
        {"name": "Reel-to-Reel", "category_slug": "music.reel", "fields": [
            ...
            {"key": "speed", "label": "Speed (IPS)", "type": "select",
             "options": ["1⅞", "3¾", "7½", "15"]},            {"key": "track_config", "label": "Track config", "type": "select",
             "options": ["2-track stereo", "4-track stereo", "Mono", "8-track"]},
            {"key": "tape_width", "label": "Tape width", "type": "select",
             "options": ["\u00bc\"", "\u00bd\"", "1\"", "2\""]},        ]},
    ],
    "movies": [
        ...
        {"name": "LaserDisc", "category_slug": "movies.laserdisc", "fields": [
            {"key": "studio", "label": "Studio", "type": "text"},
            {"key": "director", "label": "Director", "type": "text"},
            {"key": "release_year", "label": "Release year", "type": "number"},
            {"key": "region", "label": "Region", "type": "select",
             "options": ["NTSC", "PAL"]},
            {"key": "disc_format", "label": "Disc format", "type": "select",
             "options": ["CLV", "CAV", "Extended Play"]},
            {"key": "disc_count", "label": "Disc count", "type": "number"},
            {"key": "catalog_no", "label": "Catalog #", "type": "text"},
            {"key": "upc", "label": "UPC", "type": "text"},
        ]},
    ...
    "books": [
        {"name": "Book", "category_slug": "books.print", "fields": [
            ...
            {"key": "signed", "label": "Signed copy", "type": "boolean"},
        ]},
        {"name": "Comic / Graphic Novel", "category_slug": "books.comic", "fields": [
            ...
            {"key": "graded_by", "label": "Graded by", "type": "select",
             "options": ["CGC", "CBCS", "PGX", "Raw"]},
            {"key": "cert_number", "label": "Cert / label #", "type": "text"},
    ...
    "games": [
        {"name": "Game", "category_slug": "games.software", "fields": [
            ...
            {"key": "format", "label": "Format", "type": "select",
             "options": ["Cartridge", "CD-ROM", "DVD-ROM", "Blu-ray", "Download",
                         "Card", "Flash Card", "Other"]},
            {"key": "edition", "label": "Edition", "type": "text"},
            {"key": "region", "label": "Region", "type": "select",
             "options": ["NTSC", "PAL", "NTSC-J", "Region-Free"]},
            {"key": "rating", "label": "Rating", "type": "select",
             "options": ["E", "E10+", "T", "M", "AO", "RP"]},
            {"key": "completeness", "label": "Completeness", "type": "select",
             "options": ["Sealed", "CIB", "Loose", "Manual Only", "Box Only"]},
            {"key": "cib", "label": "Complete in box", "type": "boolean"},
            {"key": "manual_included", "label": "Manual included", "type": "boolean"},
            {"key": "components_included", "label": "Included components", "type": "text"},
            {"key": "collection_status", "label": "Collection status", "type": "select",
             "options": ["In Collection", "Want List", "For Trade", "For Sale", "Sold"]},
            {"key": "my_rating", "label": "My rating (0–10)", "type": "number"},
            {"key": "purchase_date", "label": "Purchase date", "type": "date"},
            {"key": "purchase_store", "label": "Purchase store", "type": "text"},
            {"key": "disc_serial", "label": "Disc / cart serial #", "type": "text"},
            {"key": "upc", "label": "UPC", "type": "text"},
        ]},
        {"name": "Console / Hardware", "category_slug": "games.console", "fields": [
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "model", "label": "Model #", "type": "text"},
            {"key": "model_variant", "label": "Hardware revision", "type": "text"},
            {"key": "color", "label": "Color", "type": "text"},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "region", "label": "Region", "type": "select",
             "options": ["NTSC", "PAL", "NTSC-J"]},
        ]},
        {"name": "Handheld", "category_slug": "games.handheld", "fields": [
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "model", "label": "Model", "type": "text"},
            {"key": "model_variant", "label": "Hardware revision", "type": "text"},
            {"key": "color", "label": "Color", "type": "text"},
    ...
    "collectibles": [
        {"name": "Trading Card", "category_slug": "collectibles.trading_card", "fields": [
            ...
            {"key": "year", "label": "Year", "type": "number"},
            {"key": "player_subject", "label": "Player / subject", "type": "text"},
            {"key": "parallel", "label": "Parallel / variant", "type": "text"},
            {"key": "print_run", "label": "Print run", "type": "number"},
            {"key": "grade", "label": "Grade", "type": "text"},
            {"key": "graded_by", "label": "Graded by", "type": "select",
             "options": ["PSA", "BGS", "CGC", "SGC", "Raw"]},
            {"key": "cert_number", "label": "Cert #", "type": "text"},
            {"key": "population_count", "label": "Pop report count", "type": "number"},
        ]},
        {"name": "Action Figure / Funko", "category_slug": "collectibles.action_figure", "fields": [
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "character", "label": "Character", "type": "text"},
            {"key": "series_line", "label": "Series / line", "type": "text"},
            {"key": "scale", "label": "Scale / size", "type": "text"},
            {"key": "year", "label": "Year", "type": "number"},
        ...
        {"name": "Coin", "category_slug": "collectibles.coin", "fields": [
            {"key": "country", "label": "Country", "type": "text"},
            ...
            {"key": "grade", "label": "Grade", "type": "text"},
            {"key": "graded_by", "label": "Graded by", "type": "select",
             "options": ["PCGS", "NGC", "ANACS", "ICG", "Raw"]},
            {"key": "cert_number", "label": "Cert #", "type": "text"},
            {"key": "population_count", "label": "Pop report count", "type": "number"},
            {"key": "diameter_mm", "label": "Diameter (mm)", "type": "number"},
            {"key": "weight_g", "label": "Weight (g)", "type": "number"},
            {"key": "catalog_ref", "label": "Catalog ref (e.g. KM#168)", "type": "text"},
        ]},
        {"name": "Stamp", "category_slug": "collectibles.stamp", "fields": [
            {"key": "country", "label": "Country", "type": "text"},
            {"key": "year_issued", "label": "Year issued", "type": "number"},
            {"key": "denomination", "label": "Denomination", "type": "text"},
            {"key": "scott_number", "label": "Scott #", "type": "text"},
            {"key": "michel_number", "label": "Michel #", "type": "text"},
            {"key": "color_description", "label": "Color description", "type": "text"},
            ...
            {"key": "condition", "label": "Condition", "type": "select",
             "options": ["Mint NH", "Mint HR", "Used", "CTO", "Faulty"]},
            {"key": "centering", "label": "Centering", "type": "select",
             "options": ["Superb", "Extremely Fine", "Very Fine", "Fine", "Good", "Poor"]},
            {"key": "cancel_type", "label": "Cancel type", "type": "select",
             "options": ["N/A", "CDS", "Manuscript", "Machine", "CTO"]},
            {"key": "hinged", "label": "Hinged", "type": "boolean"},
            {"key": "certificate", "label": "Certificate / expertization", "type": "text"},
        ]},
        {"name": "Signed Memorabilia", "category_slug": "collectibles.memorabilia", "fields": [
            ...
            {"key": "sport_or_field", "label": "Sport / field", "type": "text"},
            {"key": "has_coa", "label": "Certificate of authenticity", "type": "boolean"},
            {"key": "coa_issuer", "label": "COA issuer", "type": "text"},
    ...
    "technology": [
        {"name": "Vintage Computer", "category_slug": "technology.vintage_computer", "fields": [
            {"key": "manufacturer", "label": "Manufacturer", "type": "text", "required": True},
            {"key": "make", "label": "Model line", "type": "text", "required": True},
            {"key": "model", "label": "Sub-model", "type": "text"},
            {"key": "hardware_revision", "label": "Hardware revision", "type": "text",
             "help": "e.g. VA1, Rev 6A, 2-layer vs 4-layer board"},
            {"key": "form_factor", "label": "Form factor", "type": "select",
             "options": ["Desktop", "Tower", "All-in-One", "Luggable / Portable", "Laptop", "Single-Board"]},
            {"key": "cpu", "label": "CPU", "type": "text"},
            {"key": "ram", "label": "RAM", "type": "text"},
            {"key": "storage_type", "label": "Storage type", "type": "text"},
            {"key": "video_standard", "label": "Video standard", "type": "select",
             "options": ["NTSC", "PAL", "SECAM", "CGA", "EGA", "VGA", "Other"]},
            {"key": "power_requirements", "label": "Power requirements", "type": "text",
             "help": "e.g. 9V DC Center Negative, 120V AC"},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
        ]},
        {"name": "Audio / Hi-Fi Component", "category_slug": "technology.hifi", "fields": [
            {"key": "component_type", "label": "Component type", "type": "select",
             "options": ["Integrated Amplifier", "Receiver", "Preamplifier", "Power Amplifier",
                         "Turntable", "CD Player", "Tape Deck", "Reel-to-Reel Deck", "DAC",
                         "Network Player / Streamer", "Speakers", "Subwoofer", "Headphone Amp",
                         "Equalizer", "Tuner", "Other"]},
            {"key": "brand", "label": "Brand", "type": "text", "required": True},
            {"key": "model", "label": "Model", "type": "text", "required": True},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "vintage_year", "label": "Year", "type": "number"},
            {"key": "output_power_watts", "label": "Output power (W/ch)", "type": "number"},
            {"key": "impedance_ohms", "label": "Impedance (Ω)", "type": "text"},
            {"key": "purchase_date", "label": "Purchase date", "type": "date"},
            {"key": "warranty_expiry", "label": "Warranty expiry", "type": "date"},
            {"key": "last_service_date", "label": "Last service date", "type": "date"},
        ]},
        {"name": "Camera", "category_slug": "technology.camera", "fields": [
            {"key": "camera_type", "label": "Camera type", "type": "select",
             "options": ["Film SLR", "DSLR", "Mirrorless", "Rangefinder", "Medium Format",
                         "Large Format", "Point & Shoot", "Instant / Polaroid", "Video / Camcorder", "Other"]},
            {"key": "brand", "label": "Brand", "type": "text", "required": True},
            {"key": "model", "label": "Model", "type": "text", "required": True},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "sensor_or_film_format", "label": "Sensor / film format", "type": "text",
             "help": "e.g. Full Frame, APS-C, Micro Four Thirds, 35mm, 120"},
            {"key": "lens_mount", "label": "Lens mount", "type": "text"},
            {"key": "year", "label": "Year", "type": "number"},
            {"key": "purchase_date", "label": "Purchase date", "type": "date"},
            {"key": "warranty_expiry", "label": "Warranty expiry", "type": "date"},
        ]},
        {"name": "Smartphone / Tablet", "category_slug": "technology.mobile", "fields": [
            {"key": "brand", "label": "Brand", "type": "text", "required": True},
            {"key": "model", "label": "Model", "type": "text", "required": True},
        ...
        {"name": "Consumer Electronics", "category_slug": "technology.consumer_electronics", "fields": [
    ...
    "instruments": [
        {"name": "String Instrument", "category_slug": "instruments.string", "fields": [
            {"key": "instrument_type", "label": "Instrument type", "type": "select",
             "options": ["Acoustic Guitar", "Electric Guitar", "Bass Guitar", "Classical Guitar",
                         "Violin", "Viola", "Cello", "Double Bass", "Mandolin", "Banjo", "Ukulele", "Other"]},
            {"key": "manufacturer", "label": "Manufacturer / luthier", "type": "text"},
            {"key": "model", "label": "Model", "type": "text"},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "year_built", "label": "Year built", "type": "number"},
            {"key": "country_of_origin", "label": "Country of origin", "type": "text"},
            {"key": "top_wood", "label": "Top wood", "type": "text"},
            {"key": "back_sides_wood", "label": "Back & sides wood", "type": "text"},
            {"key": "scale_length", "label": "Scale length", "type": "text"},
            {"key": "nut_width", "label": "Nut width", "type": "text"},
            {"key": "last_setup_date", "label": "Last setup date", "type": "date"},
            {"key": "case_included", "label": "Case included", "type": "boolean"},
        ]},
        {"name": "Keyboard / Piano", "category_slug": "instruments.keyboard", "fields": [
            {"key": "instrument_type", "label": "Instrument type", "type": "select",
             "options": ["Grand Piano", "Upright Piano", "Electric Piano", "Synthesizer",
                         "Workstation", "Organ", "Accordion", "Other"]},
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "model", "label": "Model", "type": "text"},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "num_keys", "label": "Number of keys", "type": "number"},
            {"key": "weighted_keys", "label": "Weighted keys", "type": "boolean"},
            {"key": "year_built", "label": "Year built", "type": "number"},
            {"key": "last_tuning_date", "label": "Last tuning date", "type": "date"},
        ]},
        {"name": "Wind Instrument", "category_slug": "instruments.wind", "fields": [
            {"key": "instrument_type", "label": "Instrument type", "type": "select",
             "options": ["Trumpet", "Cornet", "Flugelhorn", "Trombone", "French Horn", "Tuba",
                         "Flute", "Piccolo", "Clarinet", "Oboe", "Bassoon",
                         "Alto Saxophone", "Tenor Saxophone", "Baritone Saxophone", "Soprano Saxophone",
                         "Recorder", "Harmonica", "Other"]},
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "model", "label": "Model", "type": "text"},
            {"key": "serial_number", "label": "Serial number", "type": "text"},
            {"key": "year_built", "label": "Year built", "type": "number"},
        ...
        {"name": "Drum / Percussion", "category_slug": "instruments.drums", "fields": [
            {"key": "instrument_type", "label": "Instrument type", "type": "select",
             "options": ["Acoustic Kit", "Electronic Kit", "Snare Drum", "Bass Drum",
                         "Tom", "Hi-Hat", "Cymbal", "Hand Drum / Djembe", "Cajon",
                         "Xylophone / Marimba", "Vibraphone", "Other"]},
            {"key": "manufacturer", "label": "Manufacturer", "type": "text"},
            {"key": "model", "label": "Model", "type": "text"},
            {"key": "shell_material", "label": "Shell material", "type": "text"},
            {"key": "year", "label": "Year", "type": "number"},
            {"key": "last_head_change", "label": "Last head change", "type": "date"},
        ]},
    ],
    "wine_spirits": [
        {"name": "Wine", "category_slug": "wine_spirits.wine", "fields": [
            {"key": "producer", "label": "Producer / winery", "type": "text", "required": True},
            {"key": "appellation", "label": "Appellation / AOC", "type": "text"},
            {"key": "vintage_year", "label": "Vintage year", "type": "number"},
            {"key": "varietal", "label": "Varietal / blend", "type": "text"},
            {"key": "region", "label": "Region", "type": "text"},
            {"key": "country", "label": "Country", "type": "text"},
            {"key": "bottle_size_ml", "label": "Bottle size (mL)", "type": "select",
             "options": ["187", "375", "750", "1000", "1500", "3000", "6000"]},
            {"key": "alcohol_pct", "label": "ABV (%)", "type": "number"},
            {"key": "cellar_location", "label": "Cellar location / bin", "type": "text"},
            {"key": "drink_from_year", "label": "Drink from (year)", "type": "number"},
            {"key": "drink_by_year", "label": "Drink by (year)", "type": "number"},
            {"key": "critical_score", "label": "Critics score", "type": "text"},
        ]},
        {"name": "Spirits", "category_slug": "wine_spirits.spirits", "fields": [
            {"key": "spirit_category", "label": "Category", "type": "select",
             "options": ["Whiskey / Bourbon", "Scotch", "Irish Whiskey", "Japanese Whisky",
                         "Rum", "Tequila", "Mezcal", "Gin", "Vodka", "Brandy / Cognac",
                         "Liqueur", "Other"]},
            {"key": "producer", "label": "Producer / distillery", "type": "text", "required": True},
            {"key": "expression", "label": "Expression / label", "type": "text"},
            {"key": "age_statement", "label": "Age statement", "type": "text"},
            {"key": "abv_pct", "label": "ABV (%)", "type": "number"},
            {"key": "bottle_size_ml", "label": "Bottle size (mL)", "type": "select",
             "options": ["50", "200", "375", "750", "1000", "1750"]},
            {"key": "bottling_date", "label": "Bottling date", "type": "date"},
            {"key": "purchase_date", "label": "Purchase date", "type": "date"},
