...
from covet.api import api_router
from covet.bootstrap import bootstrap_admin_if_needed, ensure_data_dirs, run_migrations
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    from covet.security import load_or_create_secret_key
    ...
    from covet.hardening import install_hardening

    install_hardening(app, settings)

    # Observability (request log + Prometheus /metrics)
    from covet.observability import install_observability
