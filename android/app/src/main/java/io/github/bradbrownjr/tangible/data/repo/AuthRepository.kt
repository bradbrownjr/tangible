...
import io.github.bradbrownjr.tangible.data.auth.normalizedBaseUrl
import io.github.bradbrownjr.tangible.data.remote.LoginRequest
import io.github.bradbrownjr.tangible.di.NetworkModule
 ...
 *
 * The Hilt-provided [TangibleApi] reads its base URL on construction so callers must
